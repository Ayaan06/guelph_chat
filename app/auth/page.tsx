...
function AuthContent() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-900 text-white">
      <div className="mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 items-center gap-10 px-6 py-12 lg:grid-cols-[1.05fr,1.1fr]">
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-slate-200/80">
              ...
              password to continue, or drop a quick hello in the global chat as
              Anonymous.
            </p>
          </div>
        ...
        <section className="relative w-full max-w-3xl overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-indigo-900/40 backdrop-blur">
          ...
          <div className="relative grid gap-6 lg:grid-cols-[1.05fr,0.95fr]">
              ...
              <div className="space-y-4">
                ...
                <form onSubmit={handleCredentials} className="space-y-4">
                  ...
                  <p className="text-xs text-indigo-50/80">
                    All accounts use the same Prisma database. If you already
                    have a Google account with this email, please sign in with
                    Google instead.
                  </p>
                </form>
              </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-slate-950/30 p-2 lg:p-1">
              <AnonymousGlobalChat />
            </div>
          </div>
        </section>
